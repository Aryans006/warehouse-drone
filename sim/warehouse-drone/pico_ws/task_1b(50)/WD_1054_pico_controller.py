...
class Swift_Pico(Node):
	def __init__(self):
		...
		self.setpoint = [1.8, 1.8, 18.8] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
	...
	#  [roll pitch throttle]
			...
			self.Kp[2] = 130 * 0.5  # throttle
			self.Ki[2] = 29 * 0.00052
			self.Kd[2] = 3400 * 0.3

			self.Kp[1] = 42 * 0.4  # pitch
			self.Ki[1] = 12 * 0.000057
			self.Kd[1] = 655  * 0.9

			self.Kp[0] = 40 * 0.23  # roll
			self.Ki[0] = 25 * 0.000065
			self.Kd[0] = 2750 * 0.17
