...
class WayPointServer(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(Int32MultiArray, '/point_published', self.points_callback, 10)
        ...
        # while self.newflag == False:
        #     if len(self.goal_array1) == 0:
        #         self.get_logger().info("Waiting for a message...")
        #         print("idhr aa gya")
        #         print(self.goal_array1)
        #     else:
        #         self.newflag = True        
            # if rclpy.ok():
            #     rclpy.spin_once(WayPointServer)
    ...
    def points_callback(self,msg):
        ...
        self.goal_array3 = self.pixel_to_whycon(data[4], data[5])
        # print("goal array", self.goal_array1)
    ...
    def execute_callback(self, goal_handle):
        ...
        while True:
            ...
            # print("goalarray",self.goal_array1)
            # time.sleep(1)
            ...
            if ((self.rounded_equal(self.setpoint, self.goal_array1)) or (self.rounded_equal(self.setpoint, self.goal_array2)) or (self.rounded_equal(self.setpoint, self.start_point))):
                ...
                drone_is_in_sphere5 = self.is_drone_in_sphere(self.drone_position, self.goal_array3, 0.6) 
