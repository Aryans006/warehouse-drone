...
class WayPointServer(Node):
    ...
    def __init__(self):
        ...
        self.Kp[2] = 17 * 0.6  # throttle
        self.Ki[2] = 10 * 0.000051
        self.Kd[2] = 500 * 0.5

        self.Kp[1] = 42 * 0.5  # pitch
        self.Ki[1] = 12 * 0.000057
        self.Kd[1] = 750  * 0.9

        self.Kp[0] = 40 * 0.5  # roll
    ...
    def pid(self):
        ...
        self.iterm[3] = (self.iterm[3] + self.error[3]) #error in yaw
